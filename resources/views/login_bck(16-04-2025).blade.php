        ...
        <div class="login__container">
            <form action="{{ route('loginaction') }}" method="post" class="login__form">
                ...
                <div class="login__check">
                    ...
                    <a href="{{ route('otp.form') }}" style="text-decoration: none" class="login__forgot">Forgot Password?</a>
                </div>

                <button type="submit" class="login__button">Login</button>

                <div class="login__register"  >
                    Don't have an account? <a href="{{ route('signup') }}" style="text-decoration: none">Register</a>
                </div>
            </form>
        </div>
    </div>

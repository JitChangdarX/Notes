...
class OTPController extends Controller
{
    ...
    public function sendOtp(Request $request)
    {
        ...
        if (!$signup) {
            ...
            return redirect()->route('signup')->withErrors(['email' => 'This email is not registered. Please sign up first.']);
        }
    ...
    public function updatePassword(Request $request)
    {
        ...
        if (Hash::check($request->new_password, $signup->password)) {
            Log::warning('New password matches current password for email: ' . $email);
        ...
        try {
            ...
            // Update password
            $signup->password = Hash::make($request->new_password); // Ensure password is hashed
            $signup->save();

    ...
    <div class="login">
        ...
        <form action="" class="login__form">
            ...
            <div class="login__inputs">
                ...
                <div class="login__box">
                    <input type="password" placeholder="Password" name="password" required class="login__input" id="password">
                    <i class="ri-lock-2-fill"></i>
                </div>
            </div>
            <div class="login__check">
                <div class="login__check-box">
                    <input type="checkbox" class="login__check-input" id="user-check" onclick="myFunction()">
